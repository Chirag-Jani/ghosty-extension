...
import { Shield, Download, FileArchive } from "lucide-react";
      ...
      <AlertDialogContent className="max-w-md">
        <AlertDialogHeader>
          ...
          <AlertDialogDescription className="text-left space-y-3 pt-2">
            <p>
              You're about to download the <strong>Veil Extension</strong> zip file.
            </p>
            ...
            <div className="space-y-2 pt-2">
              ...
              <ol className="list-decimal list-inside space-y-1 text-sm text-muted-foreground ml-2">
                ...
                <li>Open Chrome/Brave and go to <code className="bg-muted px-1 py-0.5 rounded text-xs">chrome://extensions</code></li>
            ...
            <div className="flex items-start gap-2 pt-2 border-t border-border mt-4">
              ...
              <p className="text-xs text-muted-foreground">
                The file will be saved as <code className="bg-muted px-1 py-0.5 rounded">veil-extension.zip</code> in your downloads folder.
              </p>
            </div>
          </AlertDialogDescription>
        </AlertDialogHeader>
